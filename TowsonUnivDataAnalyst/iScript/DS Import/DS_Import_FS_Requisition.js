//DS_Import_FS_Requisition.js
/********************************************************************************
Name:			DS_Import_FS_Requisition.js
Author:			Jay Taffel (Copied from AP_MEV_Import_DocuSign.js by ECB)
Created:		07/16/2019 ECB - OPW TechHelp 291903; completed by Jay Taffel 7/17/2019
Last Updated:	
For Version:	7.x
Script Version: $Id$
---------------------------------------------------------------------------------
Summary:
		Imports Requisitions for Purchases for FS (Procurement).

Mod Summary: 	02/19/2020 TechHelp ###### JMT & JM Renaming the script filename from "FS_Requisition_Import_DocuSign.js" to "DS_Import_FS_Requisition.js"
...
Program Logic:
	 Loop
		...
		RequisitionForPurchases (literal value, used as unique field to only export requisitions, will not be used)
		Contact Name (F1 temporary value, will eventually be the Requisition Number),
		Fiscal Year (F3),
		Department Number (F4),
		...
		All files to be hard coded Drawer: Procurement_Requisitions, Field5: date/time stamp and doctype: 'Requisition for Purchase.'
		All files routed to Workflow queue: "FCC Start", eventually to Requisition_Index.
...
var debug = "";
var strThisScript = "DS_Import_FS_Requisition.js";
...
//Import directories
/*
var IMPORT_DIR		= "\\\\customshare\\ImageNowImport\\Retrieve_Testing\\Procurement\\RequisitionForPurchase\\";
var ARCHIVE_DIR		= "\\\\customshare\\ImageNowImport\\Retrieve_Testing\\Procurement\\RequisitionForPurchase\\complete\\";
var ERROR_DIR		= "\\\\customshare\\ImageNowImport\\Retrieve_Testing\\Procurement\\RequisitionForPurchase\\failed\\";
*/

var IMPORT_DIR		= "\\\\secureshare\\ots-docusign\\ImageNowImport\\DocuSign_Retrieve\\Procurement\\RequisitionForPurchases\\";
var ARCHIVE_DIR		= "\\\\secureshare\\ots-docusign\\ImageNowImport\\DocuSign_Retrieve\\Procurement\\RequisitionForPurchases\\complete\\";
var ERROR_DIR		= "\\\\secureshare\\ots-docusign\\ImageNowImport\\DocuSign_Retrieve\\Procurement\\RequisitionForPurchases\\failed\\";


//Workflow Queues
var Q_COMPLETE = "FCC Start"  //"Requisition_Index";
...
"RequisitionForPurchases","ContactNameText","FYText","DepartmentNumberText","Envelope Id"
"RequisitionForPurchases","Robert Zengel","2019","18950","57fe7087-bd4b-4df6-916a-ea3f8e59cc1c"
"","","","","57fe7087-bd4b-4df6-916a-ea3f8e59cc1c"

***/
#define CSV_HEADER_LINE_COUNT 1  //0 no header
var CSV_CONFIG =
[
	{name:"RequisitionForPurchases"},
	{name:"ContactNameText"}, //Field1
	{name:"FYText"}, //Field3
	{name:"DepartmentNumberText"},  //Field4
...
function main ()
{
	try
	{
		...
		while (true)
		{
			...
			if (!line) break;
			cntCSVRow++;
			debug.logln(5, "File [%s] | ContactNameText aka Field2 [%s]", line["FileName"], line["ContactNameText"]);

			//Check if have Payee. If so, save for next line. If not, then this person has an attachment.
			if (line["ContactNameText"] == "")
			{
			...
			if (fileExists) //it is there, get it and import into PC using CSV index values
			{
				...
				var keys = new INKeys("Procurement_Requisitions", "", line["ContactNameText"], line["FYText"], line["DepartmentNumberText"], strNow, "Requisition for Purchase");
		...
		ListBCC = "";
		MailSubject = "Requisition for Purchase DocuSign Statistics";
		MailBody = "The script importing Requisition for Purchase DocuSign files into Perceptive Content has completed successfully.\n\n"; 
