...
---------------------------------------------------------------------------------
Summary:
		Imports GraduateAssistantship Appointment forms for PBO. Hardcode the files with TUID", "CandidateName","FiscalYearDropdown","CompletedDate","Envelope Id"
...
Mod Summary:
		...
		04/15/2020 TechHelp 329071 Continued Testing, all is looking good. Set as Production script, added Heather Wilson to ListTo.
...
var debug = "";
var strThisScript = "DS_Import_PBO_GA_Appoint.js";
...
// ********************* Global variables ********************
//Import directories for GA_Appointment
var IMPORT_DIR		= "\\\\secureshare\\ots-docusign\\ImageNowImport\\DocuSign_Retrieve\\PBO\\GA_Appointment\\";
var ARCHIVE_DIR		= "\\\\secureshare\\ots-docusign\\ImageNowImport\\DocuSign_Retrieve\\PBO\\GA_Appointment\\complete\\";
var ERROR_DIR		= "\\\\secureshare\\ots-docusign\\ImageNowImport\\DocuSign_Retrieve\\PBO\\GA_Appointment\\failed\\";
...
var idx_DOCTYPE = "PBO_GA_Appointment"; //Double check once
...
function main ()
{
	try
	{
		...
		ListBCC = "";
		MailSubject = "DS_Import_PBO_GA_Appoint DocuSign Statistics";
		MailBody = "The script importing GraduateAssistantship Appointment DocuSign files into Perceptive Content has completed successfully.\n\n";
		//Do NOT touch below
		...
		if (cntAttachments > 0)
		{
			MailBody += "\n TU_ID's of GraduateAssistantship Appointment with attachments.\nBoth names should match.\n";
