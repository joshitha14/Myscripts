...
<!-- 								<input class="fieldcell" type="text" name="txtInvoiceNbr" id="txtInvoiceNbr" readonly="true" style="width:120px" dbSet="TU_GetStudentInfo" dbSet_param="3">  -->
					...
					<table class="contentsection" style="border:2px solid black;width:450;text-align:left;">
						<tbody>
							...
							<tr>
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtDept2" id="txtDept2" style="width:100px" onkeypress="return chkKeys(event, 'N');" onblur="validateSpeedType(this);">
										<xsl:attribute name="value">
								...
								<p>
									<strong>$</strong>
									<input class="fieldcell" type="text" name="txtAmount2" id="txtAmount2" style="width:80px" onkeypress="return chkKeys(event, 'N');" onblur="calcTotalAmount('2');">
										<xsl:attribute name="value">
							...
							<tr>
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtDept3" id="txtDept3" style="width:100px" onkeypress="return chkKeys(event, 'N');" onblur="validateSpeedType(this);">
										<xsl:attribute name="value">
								...
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtInit3" id="txtInit3" style="width:80px" onkeypress="return chkKeys(event, 'AN');">
										<xsl:attribute name="value">
								...
								<p>
									<strong>$</strong>
									<input class="fieldcell" type="text" name="txtAmount3" id="txtAmount3" style="width:80px" onkeypress="return chkKeys(event, 'N');" onblur="calcTotalAmount('3');">
										<xsl:attribute name="value">
							...
							<tr>
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtDept4" id="txtDept4" style="width:100px" onkeypress="return chkKeys(event, 'N');" onblur="validateSpeedType(this);">
										<xsl:attribute name="value">
								...
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtInit4" id="txtInit4" style="width:80px" onkeypress="return chkKeys(event, 'AN');">
										<xsl:attribute name="value">
								...
								<p>
									<strong>$</strong>
									<input class="fieldcell" type="text" name="txtAmount4" id="txtAmount4" style="width:80px" onkeypress="return chkKeys(event, 'N');" onblur="calcTotalAmount('4');">
										<xsl:attribute name="value">
							...
							<tr>
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtDept5" id="txtDept5" style="width:100px" onkeypress="return chkKeys(event, 'N');" onblur="validateSpeedType(this);">
										<xsl:attribute name="value">
								...
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtInit5" id="txtInit5" style="width:80px" onkeypress="return chkKeys(event, 'AN');">
										<xsl:attribute name="value">
								...
								<p>
									<strong>$</strong>
									<input class="fieldcell" type="text" name="txtAmount5" id="txtAmount5" style="width:80px" onkeypress="return chkKeys(event, 'N');" onblur="calcTotalAmount('5');">
										<xsl:attribute name="value">
							...
							<tr>
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtDept6" id="txtDept6" style="width:100px" onkeypress="return chkKeys(event, 'N');" onblur="validateSpeedType(this);">
										<xsl:attribute name="value">
								...
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtInit6" id="txtInit6" style="width:80px" onkeypress="return chkKeys(event, 'AN');">
										<xsl:attribute name="value">
								...
								<p>
									<strong>$</strong>
									<input class="fieldcell" type="text" name="txtAmount6" id="txtAmount6" style="width:80px" onkeypress="return chkKeys(event, 'N');" onblur="calcTotalAmount('6');">
										<xsl:attribute name="value">
							...
							<tr>
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtDept7" id="txtDept7" style="width:100px" onkeypress="return chkKeys(event, 'N');" onblur="validateSpeedType(this);">
										<xsl:attribute name="value">
								...
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtInit7" id="txtInit7" style="width:80px" onkeypress="return chkKeys(event, 'AN');">
										<xsl:attribute name="value">
								...
								<p>
									<strong>$</strong>
									<input class="fieldcell" type="text" name="txtAmount7" id="txtAmount7" style="width:80px" onkeypress="return chkKeys(event, 'N');" onblur="calcTotalAmount('7');">
										<xsl:attribute name="value">
							...
							<tr>
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtDept8" id="txtDept8" style="width:100px" onkeypress="return chkKeys(event, 'N');" onblur="validateSpeedType(this);">
										<xsl:attribute name="value">
								...
								<td class="labelcell" style="width:100px">
									<input class="fieldcell" type="text" name="txtInit8" id="txtInit8" style="width:80px" onkeypress="return chkKeys(event, 'AN');">
										<xsl:attribute name="value">
								...
								<p>
									<strong>$</strong>
									<input class="fieldcell" type="text" name="txtAmount8" id="txtAmount8" style="width:80px" onkeypress="return chkKeys(event, 'N');" onblur="calcTotalAmount('8');">
										<xsl:attribute name="value">
