 ...
 function calcTotalAmount(strPos)
{
	...
	//AmtTotal.value = "SPEEDTYPE";  //tempvalue.toFixed(2);
	if (strPos != "0")
	{
		//var strTest = document.getElementById('txtDept'+ strPos).value
		//alert("[" + document.getElementById('txtDept'+ strPos).value + "]\n" + strTest.length + strTest);
		if (document.getElementById('txtAccount'+ strPos).value == "" && document.getElementById('txtAmount'+ strPos).value != "")
		{
			alert("Please fill in an Account # for line " + strPos + ".");
	...
	if (strPos != "0")
	{
		//var strTest = document.getElementById('txtDept'+ strPos).value
		//alert("[" + document.getElementById('txtDept'+ strPos).value + "]\n" + strTest.length + strTest);
		if (document.getElementById('txtDept'+ strPos).value == "" && document.getElementById('txtAmount'+ strPos).value != "")
//		(document.getElementById('txtAccount'+ strPos).value == "" && document.getElementById('txtAmount'+ strPos).value != "")
		{
			alert("Please fill in a Dept./Grant # for line " + strPos + ".");
...
/**	if (strPos != "0")
	{
		...
		if (document.getElementById('txtAccount'+ strPos).value == "" && document.getElementById('txtAmount'+ strPos).value != "")
		{
			alert("Please fill in a Account # for line " + strPos + ".");
			document.getElementById('txtAccount'+ strPos).focus();
		}
	} */
}
